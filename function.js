(function ($) {
	...
	$(window).on("scroll", function() {
		...
		setHeaderHeight();
		var headerHeight = $('header .header-sticky').outerHeight(100)
		$("header .header-sticky").toggleClass("hide", (fromTop > headerHeight + 50));
		$("header .header-sticky").toggleClass("active", (fromTop > 50));
	});
